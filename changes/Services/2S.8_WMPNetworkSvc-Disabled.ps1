# 2S.8 — WMPNetworkSvc -> Disabled. Services sector.
...
$Svc = 'WMPNetworkSvc'; $Expected = 'Disabled'

Invoke-PrimeChange -Id '2S.8' -Check:$Check -Apply:$Apply -Undo:$Undo -PreviousValueJson $PreviousValueJson `
