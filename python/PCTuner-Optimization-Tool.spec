...
Run from python/: `pyinstaller PCTuner-Optimization-Tool.spec --noconfirm`
Output: python/dist/PCTuner-Optimization-Tool.exe (bare — won't run standalone until the
...
VERSION_INFO_PATH.write_text(
    ...
    "            StringStruct('FileDescription', 'PCTuner-Optimization-Tool — Windows optimization suite'),\n"
    f"            StringStruct('FileVersion', {VERSION!r}),\n"
    "            StringStruct('InternalName', 'PCTuner-Optimization-Tool'),\n"
    "            StringStruct('OriginalFilename', 'PCTuner-Optimization-Tool.exe'),\n"
    "            StringStruct('ProductName', 'PCTuner-Optimization-Tool'),\n"
...
exe = EXE(  # noqa: F821
    ...
    a.datas,
    [],
    name="PCTuner-Optimization-Tool",
    debug=False,
